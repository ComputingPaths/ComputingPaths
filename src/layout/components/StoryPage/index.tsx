...
// StoryPage component renders a list of student stories, using alternating layouts for each story.
// The stories are displayed using StoryCard components, with data fetched from the backend.
const StoryPage: React.FC = () => {
  ...
  return (
    <div className="story-page">
      ...
      <p className="story-page-text">
        Every path through UCSD is unique, and there’s no right or wrong path. Some students have
        explored many different routes on their way to finding the right fit for them. These are
      ...
      <div className="story-page-stories">
        ...
        {data.map((story, index) => (
          <StoryCard
            key={index} // Unique key for each StoryCard
            leftToRight={index % 2 === 0} // Alternate layout for each story
