...
const ResourceCard: React.FC<ResourceCardProps> = ({
  ...
  const [visible, setVisible] = useState<boolean>(false); // State to control visibility of extra content
    ...
    <div className="resource-card">
      ...
      <a target="_blank" rel="noopener noreferrer" href={imageLink}>
        <img
          ...
          src={image || '/img/CP Generic Icon.jpg'}
          alt={name}
        />
      </a>
      ...
      <div className={`resource-card-content${visible ? ' visible' : ''}`}>
        <div>
          ...
          <div className="resource-card-tags">
            {tags.map((tag) =>
              tag ? (
                <p className={`resource-card-tag ${tag.color}`} key={tag.name}>
                  {tag.name}
                </p>
              ) : null
            )}
        ...
        >
          View More
          <img className="resource-card-view-arrow" src={LinkedArrow} alt="Arrow" />
        </button>
        ...
        <div className={`resource-card-hidden${visible ? ' visible' : ''}`}>
          ...
          <a target="_blank" rel="noopener noreferrer" href={link}>
            <p className="resource-card-link">
              Learn More
              <img className="resource-card-view-arrow" src={LinkedArrow} alt="Arrow" />
            </p>
          </a>
