...
// This component renders a page displaying various resources available at UCSD. Users
...
const ResourcePage: React.FC = () => {
  // State for storing resource tags data
  ...
  return (
    <main className="resource-page">
      ...
      <p className="resource-page-text">
        Discover the many resources available at UC San Diego: study spaces, career and research 
      ...
      <div className="resource-page-content">
        ...
        <div className="resource-page-tag-section">
          ...
          <button
            className={`resource-page-tag-button${filter === '' ? ' selected' : ''}`}
            type="button"
            onClick={() => setFilter('')}
          >
            All
          ...
          {resourceTagsData.map((resource, index) => (
            <button
              className={`resource-page-tag-button${filter === resource.name ? ' selected' : ''}`}
              type="button"
              onClick={() => setFilter(resource.name)}
              key={index}
            >
              {resource.name}
            </button>
