...
const colors = ['white', 'light-green', 'light-yellow', 'light-red', 'light-blue', 
'light-brown', 'mint'];
    ...
    <div className="orgs-page">
      <div className="orgs-page-header">
        <div className="marquee">
          {/* Marquee with hero image scrolling */}
        ...
        <p>
          Student organizations allow for extracurricular experience, utilizing and extending
          skills imparted in computing courses. These groups demonstrate creative computing 
          efforts by channeling the collaborative spirit of UC San Diego.
        </p>
        <div className="orgs-page-tag-section">
          {/* Tag buttons for filtering organizations */}
          <button 
            className={filter !== '' ? 'projects-page-tag-button' : 
            'projects-page-tag-button select'}
            type="button"
            onClick={() => setFilter('')}
          >
            All
          </button>
          {
            orgTagValues && orgTagValues.map((tagVal) => {
              if (tagVal !== 'All') {
                return (
                  <button 
                    className={filter !== tagVal ? 'orgs-page-tag-button' : 
                    'orgs-page-tag-button select'}
                    type="button"
                    onClick={() => setFilter(tagVal)}
                    key={tagVal}
                  >
                    {tagVal}
                  </button>
        ...
        <div className="projects-page-mobile-dropdown">
          ...
          <Dropdown
            ...
            options={orgTagValues}
            placeholder="Select an organization category"
