    ...
    <div>
      ...
      <div className="story-card-bottom">
        <p>
          ...
          <br />
          {authorDescriptor && (
            <span className="story-card-descriptor">{authorDescriptor}</span>
          )}
        </p>
        ...
        {linkText && linkURL && (
          ...
          >
            {linkText}
            <img className="story-card-link-arrow" src={LinkedArrow} alt="Link Arrow" />
          </a>
        )}
      </div>
    </div>
    {/* Conditionally render the photo on the right if leftToRight is false */}
    {!leftToRight && photoURL && (
      <img
