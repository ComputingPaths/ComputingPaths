...
// This component renders the main page for majors, including a list of majors and detailed
// cards for each major, with options for desktop and mobile navigation.
  ...
  return (
    <div className="major-page">
      ...
      <p className="major-page-text">
        A wide array of majors offer a unique computing experience at UCSD. These major apply
        computational skills to both new and traditional subject matter, developing programming
        skills, fostering scientific study, and bolstering creativity.
      </p>
        ...
        <div className="major-page-scroll-content">
          ...
          <div className="major-page-mobile-navigation">
            <Dropdown
              ...
              options={majorData.map((major) => major.name)}
              placeholder="Select a major"
              onChange={(major) => {
                location.hash = `#${major.value.replace(/\s/g, '-')}`;
              }}
            />
          </div>
...
export default MajorPage; // Exporting the MajorPage component