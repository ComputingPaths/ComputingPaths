...
import './style.scss'; // Importing styles specific to ProjectPage
  ...
  return (
    <main className="projects-page">
      ...
      <p className="projects-page-text">
        Computing students create impressive bodies of work throughout their time at UC San Diego,
        whether for classes, internships, or just for fun.
      </p>
      ...
      <div className="projects-page-tag-section">
        ...
        {['App', 'Art', 'Educational', 'Datamining', 'Game', 'Hardware', 'Research'].map((tag) => (
          <button
            key={tag}
            className={filter !== tag ? 'projects-page-tag-button' : 
            'projects-page-tag-button select'}
            type="button"
